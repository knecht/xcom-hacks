/*
 This is an ugly, nasty hack which should prevent the game from crashing more often than UFOs.
 ...
 See also:
 http://psydk.org/archives/2014-07-05-221-introducing-plasma-fence
